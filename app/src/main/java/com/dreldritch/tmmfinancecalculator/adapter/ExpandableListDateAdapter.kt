...
class ExpandableListDateAdapter(val context: Context, private val transactionList: List<FullTransactionData>)
    ...
    override fun getGroupCount() = dateList.size

    override fun getGroup(p0: Int) = dateList[p0]
    ...
    override fun getChildrenCount(p0: Int) = groupChildMap[dateList[p0]]!!.size
    ...
    override fun getGroupId(p0: Int) = transactionList.filter { it.date == dateList[p0] }[0].date_id!!

    override fun getChildId(p0: Int, p1: Int) = groupChildMap[dateList[p0]]!![p1].id!!
}